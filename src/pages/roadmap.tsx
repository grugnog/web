      ...
      <div className='space-y-2 py-2'>
        <PaperSection style={{ border: 'none' }}>
          ...
          <Heading variant='h6' component='h4' bold={false}>
            ...
            way. This means we acknowledge that things arent perfect but, we are
        ...
        <PaperSection>
          <div className='pb-2'>
            ...
            <Heading variant='h6' component='h4' bold={false}>
              ...
              the scripts to proper labels. Using the script panel you should be
              able to live edit the script so that the changes can be applied on
              your live website.
            </Heading>
          </div>
          <Image
