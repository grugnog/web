  ...
  return (
    <MarketingDrawer title={name} footerSpacing>
      <div className='max-w-xl'>
        <PageTitle>Brand assets</PageTitle>
        <h2 className='text-2xl'>Download official {strings.appName} logos</h2>
        <p className='text-sm'>
      ...
      <div className={'py-12'}>
        <div className='flex flex-col md:flex-row flex-1 border rounded px-12 py-16 gap-x-4 gap-y-2'>
          ...
          <div className='space-y-2 flex-1'>
            ...
            <p>
              Download {strings.appName} official logos, including as {`SVG's`}.
